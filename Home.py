...
component_pages = [
    ...
    st.Page("pages/Dialog.py", title="Dialog"),
    st.Page("pages/DropdownMenu.py", title="Dropdown Menu"),
    st.Page("pages/Empty.py", title="Empty"),
    st.Page("pages/Field.py", title="Field"),
    st.Page("pages/HoverCard.py", title="Hover Card"),
    st.Page("pages/Input.py", title="Input"),
    st.Page("pages/InputGroup.py", title="Input Group"),
    ...
    st.Page("pages/Spinner.py", title="Spinner"),
    ...
    st.Page("pages/Tooltip.py", title="Tooltip"),
]
