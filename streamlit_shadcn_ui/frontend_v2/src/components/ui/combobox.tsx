...
import { useOverlayContainer } from "@/platform/overlay-container"
...
function ComboboxContent({
  ...
  return (
    <ComboboxPrimitive.Portal container={overlayContainer}>
      <ComboboxPrimitive.Positioner
        ...
        anchor={anchor}
        className="isolate z-50" positionMethod="fixed"
      >
